================================================
Implementation of DeepCell for FUSION pre-processing of CODEX images
================================================

Plugin implementation of `DeepCell` for nuclei and cytoplasm segmentation.
...
**Source repositories:** `FUSION` | `DeepCell` | `Digital Slide Archive`_ | `HistomicsUI`_ | `large_image`_ | `slicer_cli_web`_

.. Links for everything above (not rendered):
.. _DeepCell: https://github.com/vanvalenlab/deepcell-tf
